      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl mb-12">
          ...
          <p className="text-muted-foreground mt-4 leading-relaxed">
            A comprehensive look at the products, applications, and websites we
            have delivered. Each project represents our dedication to clean
            code, responsive design, and robust performance.
          </p>
        </div>
