  ...
  return (
    <>
      <div 
        ...
        className="group relative flex flex-col h-full rounded-[2rem] border border-white/5 bg-white/[0.02] backdrop-blur-sm overflow-hidden shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] hover:bg-white/[0.04] hover:border-white/10 cursor-pointer"
      >
        ...
        <div className="flex flex-col flex-1 p-6 sm:p-8 justify-between gap-6">
          <div className="flex flex-col gap-3">
            <span className="text-[10px] font-bold text-cyan-400 uppercase tracking-[0.15em]">
              {blog.tags[0]}
            </span>
            <h3 className="text-xl font-bold tracking-tight text-white line-clamp-2 leading-snug group-hover:text-cyan-100 transition-colors">
              {blog.title}
            </h3>
            <p className="text-sm text-white/50 line-clamp-3 leading-relaxed mt-1">
              {blog.excerpt}
            </p>
          </div>
